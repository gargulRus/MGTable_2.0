...
$directorycommerc = $_SERVER['DOCUMENT_ROOT'].'/files/'.$object[0]['object_name'].'/Проект(PDF)/';
...
$directorycommerc = $_SERVER['DOCUMENT_ROOT'].'/files/'.$object[0]['object_name'].'/Проект(PDF)/';
$dirforscript ='/files/'.$object[0]['object_name'].'/Проект(PDF)/';
$scandircommerc = scandir($directorycommerc);
$pp=1;
$btnComDelete=1;
for($i=0; $i<count($scandircommerc); $i++)
{   
    ...
    {   
        $url = '/files/'.$object[0]['object_name'].'/Проект(PDF)/'.$scandircommerc[$i];
        $urlTodel = $_SERVER['DOCUMENT_ROOT'].'/files/'.$object[0]['object_name'].'/Проект(PDF)/'.$scandircommerc[$i];
        echo'
